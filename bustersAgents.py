...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for i in livingGhostPositionDistributions:
            possiblelocation = i.argMax()
            ghostlocations.append(possiblelocation)
        
        closestghostindex = 0
        maxdistance = 0
        counter = 0
        for i in ghostlocations:
            curdistance = self.distancer.getDistance( pacmanPosition , i)
        ...
        for i in legal:    
            ...
            if self.distancer.getDistance( successorPosition , ghostlocations[closestghostindex]) <= mindistance:
                mindistance = self.distancer.getDistance( successorPosition , ghostlocations[closestghostindex])
                bestmoveindex = counter
            counter += 1
        return legal[bestmoveindex]
