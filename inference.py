...
class DiscreteDistribution(dict):
    ...
    def sample(self):
        ...
        for k, v in self.items():
            if cumulativesum <= randomsample and randomsample < (cumulativesum + v):
                return k
            cumulativesum += v
...
class InferenceModule:
    ...
    def getObservationProb(self, noisyDistance, pacmanPosition, ghostPosition, jailPosition):
        ...
        "if "
        "P(noisyDistance | trueDistance) = busters.getObservationProbability(noisyDistance, trueDistance)"
    ...
    def elapseTime(self, gameState):
        ...
        for i in self.allPositions:
            ...
            for k in self.allPositions:
                distribution[k] += (newPosDist[k] * self.beliefs[i])
...
class ParticleFilter(InferenceModule):
    ...
    def initializeUniformly(self, gameState):
        ...
        self.particles = []
        "*** YOUR CODE HERE ***"
        spaces = self.numParticles // len(self.legalPositions)
    ...
    def observeUpdate(self, observation, gameState):
        ...
        for i in self.particles:
            newdist[i] += self.getObservationProb(observation, gameState.getPacmanPosition(), i , self.getJailPosition())
        if newdist.total() == 0:
            self.initializeUniformly(gameState)
        else:
            newdist.normalize()
    ...
    def elapseTime(self, gameState):
        ...
        """
        "*** YOUR CODE HERE ***"
        nextstate = DiscreteDistribution()
